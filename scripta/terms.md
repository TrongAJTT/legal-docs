...
- **Attribution & Notice:** Any redistribution or derivative work must retain all original copyright, patent, and attribution notices from the source code, as specified in the Apache License 2.0.
- **Brand & Project Identity:** The creator alias "TrongAJTT" and custom project logos/artwork are associated with this project. Nothing in this License grants permission to misrepresent the origin of the software or use the author's name/logos to endorse or promote derivative products without prior written permission, consistent with Section 6 of the Apache License 2.0.
